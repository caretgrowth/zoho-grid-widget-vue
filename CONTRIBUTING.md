# Contributing to zoho-grid-widget-vue

Love zoho-grid-widget-vue and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/caretgrowth/zoho-grid-widget-vue/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/zoho-grid-widget-vue.git
    # Navigate to the newly cloned directory
    cd zoho-grid-widget-vue
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/caretgrowth/zoho-grid-widget-vue.git
    ```
...
owners to license your work under the terms of the [GPLv3 License](https://github.com/caretgrowth/zoho-grid-widget-vue/blob/master/LICENSE.md).
